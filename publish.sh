...
echo "GitHub Actions is building your production image"
echo "with optimized caches directly on ghcr.io."
echo ""
echo "Once the GitHub Actions build finishes (~1-2 mins):"
echo "  1. Open Portainer at http://192.168.50.107:9000"
echo "  2. Update the 'mealie' stack with 'Re-pull image' enabled"
echo "============================================="
